...
load sigma_ij_2011_SLder_HF_mu032.mat
n2011_HF_032mu = sigma_ij_2011_SLder_HF;
load sigma_ij_2011_SLder_HF_mu39.mat
...
load sigma_ij_2011_SLder_bedopen_mu032.mat
n2011_bedopen_032mu = sigma_ij_2011_SLder_bedopen;
load sigma_ij_2011_SLder_bedopen_mu39.mat
...
load sigma_ij_2011_SLder_bedslip_mu032.mat
n2011_bedslip_032mu = sigma_ij_2011_SLder_bedslip;
load sigma_ij_2011_SLder_bedslip_mu39.mat
...
%%
% save n2011_allfour.mat n2011_allfour
...
set(gca,'tickdir','in','LineWidth',1.01,'FontSize',8,'FontName','Avenir','xtick',[168.5:0.5:170],'xticklabel',[]); 
grid on
...
text(169.7, 2200, '3.9 GPa','FontSize',9,'FontName','Avenir','Color',handle,'Rotation',-15);
plot([169.32+(6/24) 169.32+(6/24)],[-2000 4000],'-','LineWidth',1.2,'Color',[0.2 0.55 0.2]); %maxwell
% plus minus 032GPs and 39GPa
fill([time_2011(600:1995);flipud(time_2011(600:1995))],...
...
plot(time_2011(i),3000,'v','MarkerSize',4,'MarkerFaceColor','k','Color','k','LineWidth',0.1);
ylim([-500 3000]);  xlim([170.32-2 170.32]);
set(gca,'tickdir','in','LineWidth',1.01,'FontSize',8,'FontName','Avenir','xtick',[168.5:0.5:170]); 
grid on
...
load sigma_ij_2012_SLder_HF_mu032.mat
n2012_HF_032mu = sigma_ij_2012_SLder_HF;
load sigma_ij_2012_SLder_HF_mu39.mat
...
load sigma_ij_2012_SLder_bedopen_mu032.mat
n2012_bedopen_032mu = sigma_ij_2012_SLder_bedopen;
load sigma_ij_2012_SLder_bedopen_mu39.mat
...
%% basal slip: load stresses, calculate mean within lake basins
load sigma_ij_2012_SLder_bedslip_mu032.mat
n2012_bedslip_032mu = sigma_ij_2012_SLder_bedslip;
load sigma_ij_2012_SLder_bedslip_mu39.mat
...
%%
%save n2012_allfour.mat n2012_allfour
...
set(gca,'tickdir','in','LineWidth',1.01,'FontSize',8,'FontName','Avenir','xtick',[161:0.5:162.5]); 
grid on
ylabel('\sigma_{1,HF} [ kPa ]','FontSize',8,'FontName','Avenir');
...
ylim([-500 3000]);  xlim([162.85-2 162.85]);
legend('L1C','L1A','L1B','Location','NorthEast'); legend boxoff
set(gca,'tickdir','in','LineWidth',1.01,'FontSize',8,'FontName','Avenir','xtick',[161:0.5:162.5],'xticklabel',[]); 
grid on
ylabel('\sigma_{1,bedopen} [ kPa ]','FontSize',8,'FontName','Avenir');
...
plot([162.85 162.85],[-2000 4000],'-','LineWidth',1,'Color',[0.4 0.4 0.4]);
plot([161.85+(6/24) 161.85+(6/24)],[-2000 4000],'-','LineWidth',1.2,'Color',[0.2 0.55 0.2]); %maxwell
text(162.2, 950, '1.5 GPa','FontSize',9,'FontName','Avenir','Color',handle,'Rotation',-10);
text(162.2, 300, '0.32 GPa','FontSize',9,'FontName','Avenir','Color',handle,'Rotation',-1);
text(162.2, 2100, '3.9 GPa','FontSize',9,'FontName','Avenir','Color',handle,'Rotation',-20);
% plus minus 032GPs and 39GPa
fill([time_2012;flipud(time_2012)],...
...
% % stress values within L1A box
% n2012_allfour.princ_sigma1_NL_032mu(519)./1e3
% n2012_allfour.princ_sigma1_NL(519)./1e3
% n2012_allfour.princ_sigma1_NL_39mu(519)./1e3
% 
...
%% print figure
% figurename=sprintf('paperfig6_nif20112012_decomp_atmaxHF_20230620.png');
