...
load n2012_allfour.mat % all 3 sources + winter = "ALLFOUR"
...
text(-9.1, 6.65, '{\itStevens et al.} (2023) Movie M2','FontSize',9,'FontName','Avenir');
...
set(t2,'YTick',[-1200,-600,0,600,1200],'TickDirection','out'); 
hold all
...
text(161.20-0.05,1400,'{\itt}_{1}','Rotation',0,'FontSize',8,'FontName','Avenir'); 
text(161.72-0.05,1400,'{\itt}_{2}','Rotation',0,'FontSize',8,'FontName','Avenir'); 
text(161.85-0.05,1400,'{\itt}_{3}','FontSize',8,'FontName','Avenir'); 
text(162.85-0.05,1400,'{\itt}_{4}','Rotation',0,'FontSize',8,'FontName','Avenir'); 
text(161.85-0.07+(4/24),1400,'{\it\tau} = {6 hr}','Rotation',0,'FontSize',8,'FontName','Avenir','Color',[0.2 0.55 0.2]); 
...
plot(time_2012(i),1200,'v','MarkerSize',TriangleSize-3,'MarkerFaceColor',[0.4940 0.1840 0.5560],'Color',[0.4940 0.1840 0.5560]);

xlabel('Day of Year, 2012'); ylabel('\sigma_{1} [ kPa ]');
lgd_s1=legend('L1C','L1A','L1B');
legend boxoff
set(lgd_s1,'Position',[0.1 0.36 0.1 0.03]);
ylim([-600 1200]); xlim([162.85-3 162.85]);
text(159.15, 1500, 'c','FontSize',10,'FontWeight','bold');
text(159.15, -1600, 'e','FontSize',10,'FontWeight','bold');
set(gca,'tickdir','in','LineWidth',1.05,'FontSize',9); 
set(gca,'FontName','Avenir','ytick',[-600,0,600,1200]);
grid on
...
xlabel('Day of Year, 2012'); ylabel('\sigma_{2} [ kPa ]');
...
set(gca,'FontName','Avenir','ytick',[-600,0,600,1200]);
ylim([-600 1200]); xlim([162.85-3 162.85]);
text(159.55, 1500, 'd','FontSize',10,'FontWeight','bold');
text(159.55, -1600, 'f','FontSize',10,'FontWeight','bold');
grid on 
...
path='Animation2012_dials_2023July'; % folder path
