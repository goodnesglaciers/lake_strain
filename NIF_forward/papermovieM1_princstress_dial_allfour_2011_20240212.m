...
load n2011_allfour_surfC.mat % all 3 sources + winter = "ALLFOUR"
...
for i=130:3:1854 
fig1 = figure('Units','centimeters','Position',1.2.*[1 1 20.5 16]); clf;
    % mapview
...
text(-9.1, 6.65, '{\itStevens et al.} (2024) Movie M1','FontSize',9,'FontName','Avenir');
...
xlabel('Day of Year, 2011  [ UTC ]'); ylabel('\sigma_{1} [ kPa ]');
...
xlabel('Day of Year, 2011  [ UTC ]'); ylabel('\sigma_{2} [ kPa ]');
...
path='Animation2011_dials_2024Feb'; % folder path
