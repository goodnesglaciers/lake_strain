...
% 2021 Mar 04 LAS -- for 2012, now with strains!
% 2023 June 19 LAS -- updated with Stacy Larochelle infinitesimal strain 
...
% save NIF outputs for just t_{3} for figures
out2012_20kmB_surfC.vert_crack_open_m = vert_crack_open_m(544,:); % t_{3} index
out2012_20kmB_surfC.bed_crack_open_m = bed_crack_open_m(544,:);
out2012_20kmB_surfC.bed_crack_slip_m = bed_crack_slip_m(544,:);
out2012_20kmB_surfC.patchesB = patchesB;
out2012_20kmB_surfC.patchesC = patchesC;
% save out2012_20kmB_surfC.mat out2012_20kmB_surfC
...
sigma_ij_2012_SLder_HF.sigma_xx_vert = sigma_xx_vert;
sigma_ij_2012_SLder_HF.sigma_xy_vert = sigma_xy_vert;
sigma_ij_2012_SLder_HF.sigma_xz_vert = sigma_xz_vert;
sigma_ij_2012_SLder_HF.sigma_yx_vert = sigma_yx_vert;
sigma_ij_2012_SLder_HF.sigma_yy_vert = sigma_yy_vert;
sigma_ij_2012_SLder_HF.sigma_yz_vert = sigma_yz_vert;
sigma_ij_2012_SLder_HF.sigma_zx_vert = sigma_zx_vert;
sigma_ij_2012_SLder_HF.sigma_zy_vert = sigma_zy_vert;
sigma_ij_2012_SLder_HF.sigma_zz_vert = sigma_zz_vert;
sigma_ij_2012_SLder_HF.sigma1 = (0.5.*(sigma_xx_vert+sigma_yy_vert)) + ...
    (sqrt(((0.5.*(sigma_xx_vert-sigma_yy_vert)).^2) + (sigma_xy_vert.^2)));
sigma_ij_2012_SLder_HF.sigma2 = (0.5.*(sigma_xx_vert+sigma_yy_vert)) - ...
    (sqrt(((0.5.*(sigma_xx_vert-sigma_yy_vert)).^2) + (sigma_xy_vert.^2)));
sigma_ij_2012_SLder_HF.theta = 0.5.*(atan2((2.*sigma_xy_vert),(sigma_xx_vert-sigma_yy_vert)));
save sigma_ij_2012_SLder_HF_surfC.mat sigma_ij_2012_SLder_HF

% bedslip (just basal slip)
sigma_ij_2012_SLder_bedslip.sigma_xx_slip = sigma_xx_slip;
sigma_ij_2012_SLder_bedslip.sigma_xy_slip = sigma_xy_slip;
sigma_ij_2012_SLder_bedslip.sigma_xz_slip = sigma_xz_slip;
sigma_ij_2012_SLder_bedslip.sigma_yx_slip = sigma_yx_slip;
sigma_ij_2012_SLder_bedslip.sigma_yy_slip = sigma_yy_slip;
sigma_ij_2012_SLder_bedslip.sigma_yz_slip = sigma_yz_slip;
sigma_ij_2012_SLder_bedslip.sigma_zx_slip = sigma_zx_slip;
sigma_ij_2012_SLder_bedslip.sigma_zy_slip = sigma_zy_slip;
sigma_ij_2012_SLder_bedslip.sigma_zz_slip = sigma_zz_slip;
sigma_ij_2012_SLder_bedslip.sigma1 = (0.5.*(sigma_xx_slip+sigma_yy_slip)) + ...
    (sqrt(((0.5.*(sigma_xx_slip-sigma_yy_slip)).^2) + (sigma_xy_slip.^2)));
sigma_ij_2012_SLder_bedslip.sigma2 = (0.5.*(sigma_xx_slip+sigma_yy_slip)) - ...
    (sqrt(((0.5.*(sigma_xx_slip-sigma_yy_slip)).^2) + (sigma_xy_slip.^2)));
sigma_ij_2012_SLder_bedslip.theta = 0.5.*(atan2((2.*sigma_xy_slip),(sigma_xx_slip-sigma_yy_slip)));
save sigma_ij_2012_SLder_bedslip_surfC.mat sigma_ij_2012_SLder_bedslip

% bedopen (just basal opening)
sigma_ij_2012_SLder_bedopen.sigma_xx_open = sigma_xx_open;
sigma_ij_2012_SLder_bedopen.sigma_xy_open = sigma_xy_open;
sigma_ij_2012_SLder_bedopen.sigma_xz_open = sigma_xz_open;
sigma_ij_2012_SLder_bedopen.sigma_yx_open = sigma_yx_open;
sigma_ij_2012_SLder_bedopen.sigma_yy_open = sigma_yy_open;
sigma_ij_2012_SLder_bedopen.sigma_yz_open = sigma_yz_open;
sigma_ij_2012_SLder_bedopen.sigma_zx_open = sigma_zx_open;
sigma_ij_2012_SLder_bedopen.sigma_zy_open = sigma_zy_open;
sigma_ij_2012_SLder_bedopen.sigma_zz_open = sigma_zz_open;
sigma_ij_2012_SLder_bedopen.sigma1 = (0.5.*(sigma_xx_open+sigma_yy_open)) + ...
    (sqrt(((0.5.*(sigma_xx_open-sigma_yy_open)).^2) + (sigma_xy_open.^2)));
sigma_ij_2012_SLder_bedopen.sigma2 = (0.5.*(sigma_xx_open+sigma_yy_open)) - ...
    (sqrt(((0.5.*(sigma_xx_open-sigma_yy_open)).^2) + (sigma_xy_open.^2)));
sigma_ij_2012_SLder_bedopen.theta = 0.5.*(atan2((2.*sigma_xy_open),(sigma_xx_open-sigma_yy_open)));
save sigma_ij_2012_SLder_bedopen_surfC.mat sigma_ij_2012_SLder_bedopen

% %% load pre-saved stress calculations
% load sigma_ij_2012_SLder_HF.mat
% load sigma_ij_2012_SLder_bedopen.mat
% load sigma_ij_2012_SLder_bedslip.mat
...
%% pre-figure load datasets
    ...
    load moulin_2011.mat % 2011/2012 moulin location
...
name=sprintf('check_fig_surfC_2012_%04d',i); %what you want the file to be called
