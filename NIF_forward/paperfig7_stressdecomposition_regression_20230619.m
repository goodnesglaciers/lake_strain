...
plot(time_2011,HF_ALL_stats(:,3),'-','LineWidth',1.8,'Color',oar); hold on;
...
xlabel('Day of Year, 2011','FontName','Avenir','FontSize',m);
...
plot(time_2012,HF_ALL_stats_2012(:,3),'-','LineWidth',1.8,'Color',oar); hold on;
...
ylabel(['Correlation coefficient, {\it r},  when {\it p} ' char(8804) ' 0.01'],...
    'FontName','Avenir','FontSize',m);
xlabel('Day of Year, 2012','FontName','Avenir','FontSize',m);
set(gca,'tickdir','in','LineWidth',1.05,'FontSize',10,'FontName','Avenir'); 
set(gca,'FontName','Avenir','LineWidth',1.05,'xtick',[161:0.5:162.5]);
grid on 

% PRINT FIGURE
% figurename=sprintf('paperfig7_decomp_regression_20230620.png');
