...
xlabel('Day of Year, 2011  [ UTC ]','FontSize',8,'FontName','Avenir');
end
...
grid on
ylabel('\sigma_{1} [ kPa ]','FontSize',8,'FontName','Avenir');
xlabel('Day of Year, 2012  [ UTC ]','FontSize',8,'FontName','Avenir'); 
...
%% print figure
% figurename=sprintf('paperfig6_nif20112012_decomp_atmaxHF_surfC_20240802.png');
