...
scatter(xy_nnl_lake(:,1),xy_nnl_lake(:,2),4,'bo','filled','MarkerEdgeColor','none')
% hydrofractures
plot(patchesC(1:6:end,6),patchesC(1:6:end,7),'y','LineWidth',3)
plot(xy_SNL_crack(:,1),xy_SNL_crack(:,2),'y-','LineWidth',3)
plot(xy_NNL_crack(:,1),xy_NNL_crack(:,2),'y-','LineWidth',3)
% tick marks 
        hypot = 0.2;
% lake + winter P2
...
%% print figure
% print(gcf,'-dpng','-r500','paperfig8_roseplot360_20230620.png')