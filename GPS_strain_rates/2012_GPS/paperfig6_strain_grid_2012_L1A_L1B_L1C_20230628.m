...
clear all; close all;
load('S_neu_nif_2012.mat'); % load TRACK NEU position archive
...
ylabel('$\dot{\epsilon}_{xx}\  [\ yr^{-1}\ ]$', 'Interpreter','latex','FontSize',16);
set(gca,'xtick',[161.0,161.5,162.0,162.5]);
xlabel(' Day of Year, 2012 ','FontSize',12); 
...
xlabel(' Day of Year, 2012','FontSize',12);  grid on;
%
% print(gcf,'-dpng','-r500','paperfig5_strainrate_2012_20230628.png');
...
ylim([0 0.00004]); 
xlim([160.83 162.83]);
text(160.87, 3.6*(10^-5), 'd. L1C','FontSize',12,'FontWeight','bold'); 
text(161.17-0.013,0.000043,'\it{t}_{1}','Rotation',0,'FontSize',11,'FontName','Avenir'); 
text(161.69-0.013,0.000043,'\it{t}_{2}','Rotation',0,'FontSize',11,'FontName','Avenir'); 
text(161.83-0.013,0.000043,'\it{t}_{3}','FontSize',11,'FontName','Avenir'); 
text(162.83-0.015,0.000043,'\it{t}_{4}','Rotation',0,'FontSize',11,'FontName','Avenir'); 
...
ylim([0 0.00004]); 
xlim([160.83 162.83]);
text(160.87, 3.6*(10^-5), 'e. L1A','FontSize',12,'FontWeight','bold'); 
set(gca,'tickdir','in','LineWidth',1.1,'FontSize',12,'ytick',[0:0.00002:0.0001]); grid on;
...
ylim([0 0.00004]); 
xlim([160.83 162.83]);
text(160.87, 3.6*(10^-5), 'f. L1B','FontSize',12,'FontWeight','bold'); 
set(gca,'tickdir','in','LineWidth',1.1,'FontSize',12,'ytick',[0:0.00002:0.0001]); grid on;
ylabel('$\delta\dot{\epsilon}_{xx}\  [\ yr^{-1}\ ]$', 'Interpreter','latex','FontSize',16);
set(gca,'xtick',[161.0,161.5,162.0,162.5],'FontName','Avenir');
xlabel(' Day of Year, 2012 ','FontSize',12); 
...
ylim([0 0.00004]); 
xlim([160.83 162.83]);
text(160.87, 3.6*(10^-5), 'g. L1C','FontSize',12,'FontWeight','bold')
text(161.17-0.013,0.000043,'\it{t}_{1}','Rotation',0,'FontSize',11,'FontName','Avenir'); 
text(161.69-0.013,0.000043,'\it{t}_{2}','Rotation',0,'FontSize',11,'FontName','Avenir'); 
text(161.83-0.013,0.000043,'\it{t}_{3}','FontSize',11,'FontName','Avenir'); 
text(162.83-0.025,0.000043,'\it{t}_{4}','Rotation',0,'FontSize',11,'FontName','Avenir'); 
set(gca,'tickdir','in','LineWidth',1.1,'FontSize',12,'ytick',[0:0.00002:0.0001]); grid on;
...
ylim([0 0.00004]); 
xlim([160.83 162.83]);
text(160.87, 3.6*(10^-5), 'h. L1A','FontSize',12,'FontWeight','bold'); 
set(gca,'tickdir','in','LineWidth',1.1,'FontSize',12,'ytick',[0:0.00002:0.0001]); grid on;
ylabel('$\delta\dot{\epsilon}_{yy}\  [\ yr^{-1}\ ]$', 'Interpreter','latex','FontSize',16);
set(gca,'xtick',[161.0,161.5,162.0,162.5],'FontName','Avenir');
...
ylim([0 0.00004]); 
xlim([160.83 162.83]);
text(160.87, 3.6*(10^-5), 'i. L1B','FontSize',12,'FontWeight','bold'); 
set(gca,'tickdir','in','LineWidth',1.1,'FontSize',12,'ytick',[0:0.00002:0.0001]);
xlabel(' Day of Year, 2012 ','FontSize',12);  grid on;
ylabel('$\delta\dot{\epsilon}_{yy}\  [\ yr^{-1}\ ]$', 'Interpreter','latex','FontSize',16);
set(gca,'xtick',[161.0,161.5,162.0,162.5],'FontName','Avenir');
%
% print(gcf,'-dpng','-r500','paperfigS3_strainrate_errors_2012_20230628.png');