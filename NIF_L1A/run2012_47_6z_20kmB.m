...
%  Runs NIF and saves output as: MLE2012_47_range7_gc_20km.mat
...
if(dosetup)
  ...
  [G1, G2, G3, G2b, G3b, Rc, Rb, patchesC, patchesB]=makegeom_caseC_20km_2012(ts_enu,origin); %% change to 20 km bed
...
save MLE2012_47_range7_gc_20km.mat
% % % % %
disp('Done')       
