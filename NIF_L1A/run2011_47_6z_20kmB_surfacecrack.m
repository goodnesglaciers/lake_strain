...
%  Runs NIF and saves output as: MLE_47_all_6z_2_20kmB_surfacecrack.mat
...
if(dosetup)
  ...
  [G1, G2, G3, G2b, G3b, Rc, Rb, patchesC, patchesB]=makegeom_caseC_20km_surfacecrack(ts_enu,origin);
...
save MLE_47_all_6z_2_20kmB_surfacecrack.mat
% % % % %
