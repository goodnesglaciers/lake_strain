...
%
%'model' is an NP x NT X Nrun matrix containing the bestmodels after each sweep,
%	where NP is # of params, NT = # of temperatures, Nrun = # of runs
%
...
% modified to return all models, P. Segall 8/2001
