	function [xopt]=mycos_L1_fine(x,xdata);
...
mis=999999;
i1=0; i2=0; i3=0;
for x1i=-10:0.5:10   %loop over mean
 i1=i1+1;
 i2=0; i3=0;
 for x2i=-10:.25:10  % loop over peak-peak  %20*3.7km/s =75 km, has to allow more than cutoff
    i2=i2+1;
    i3=0;
