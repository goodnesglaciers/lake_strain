...
load surface_disp_1250m_EWcurve.mat
load Gsurface1250m_strain_EWcurve.mat
load sigma_ij_1250m_EWcurve.mat
...
hold on;
[c3,h3]=contourf(xx,yy,2.*reshape(((surface_disp_1250m.Disp_U_vert(5,:))),121,121),v_disp); 
set(h3,'LineColor','none');
...
quiver(xx_plot,yy_plot,2.*quiver_scale.*FE,2.*quiver_scale.*FN,'k','autoscale','off','LineWidth',0.6,'Color',BWR(10,:));
quiver(-9.00, 11.1, 2.*quiver_scale.*1, 2.*quiver_scale.*0, 'k','autoscale','off','LineWidth',1.0,...
    'Color',BWR(10,:),'MaxHeadSize',0.8);
text(-9, 10, '1 m','FontSize',m-1,'Color',BWR(10,:),'FontName','Avenir');
text(-11, -10.8, 'H = 1250 m   \mu = 1.5 GPa','FontName','Avenir','FontSize',m-1)
title('u_{HF} (scaled by 2X to see better)'); ylabel('y  [ km ]');
...
%% print figure
figurename=sprintf('paperfig3_idealized_example_EWcurve_20230720.png');
