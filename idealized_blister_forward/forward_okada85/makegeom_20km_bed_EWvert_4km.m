function [patchesC, patchesB, G3v, G2bv, G3bv, G3v_strain, G2bv_strain, G3bv_strain]=makegeom_20km_bed_EWvert_4km(origin,depthc)
...
buried=0.005; % buried fault (km); buried vertical HF by 5 m to avoid crack intersecting half-space surface
