...
% 05 July 2023 LAS -- include 4-km-long E-W vertical HF opening of 0.5 m 
% 20 July 2023 LAS -- include a curved HF with opening of 0.5 m; check
% \sigma_{1} stresses near the crack
% 20 July 2023 LAS -- include a curved HF with opening of 2011 t_{3} 
% distribution ; check \sigma_{1} stresses near the crack
clear all; close all

%% load Green function matrix, idealized opening and slip
load Gsurface1000m_strain_EWcurve.mat % 40 x 40 patch bed + 10-km-long vertical crack
...
%vert_crack_open_m = repmat(0.5.*ones(144,1)',5,1); % 0.5 m of vertical crack opening for all 144 subfault patches

% load 2011 NIF output, set crack open to t_3 vert open estimates
load('../../NIF_forward/MLE_47_all_6z_2_20kmB_plotting.mat')
% extract opening and slip along planes
time_2011 = ts_enu.epochs; % time vector
vert_crack_open_m_all_time = slip_b(1:Nsubfa,:)'; % m
vert_crack_open_m = repmat(vert_crack_open_m_all_time(1280,:),5,1); % m at 2011 t_{3}
...
for j=1:length(vert_crack_open_m(:,1))
    ...
    B_G3v = Gsurface.G3v*vert_crack_open_m(j,:)';
    for i=1:Nsurface
...
Disp_U_vertopenslip =  B_G3v_U + B_G2bv_U + B_G3bv_U ;
...
surface_disp_1000m.Disp_E_vertopenslip = Disp_E_vertopenslip;
surface_disp_1000m.Disp_N_vertopenslip = Disp_N_vertopenslip;
surface_disp_1000m.Disp_U_vertopenslip = Disp_U_vertopenslip;
...
surface_disp_1000m.Disp_E_vert = Disp_E_vert;
surface_disp_1000m.Disp_N_vert = Disp_N_vert;
surface_disp_1000m.Disp_U_vert = Disp_U_vert;
save surface_disp_1000m_EWcurve_2011_t3.mat surface_disp_1000m
...
for j=1:length(vert_crack_open_m(:,1))
    % vertical cracl opening (multiply by -1 to get sign convention to positive strain = TENSION)
    B_G3v = -1.*Gsurface.G3v_strain*vert_crack_open_m(j,:)'; 
    for i=1:Nsurface
        ind1=i; ind2=Nsurface+i; ind3=Nsurface*2+i;
...
duy_dx_vertopenslip =  (B_G3bv_uNE + B_G2bv_uNE + B_G3v_uNE)./1e3;
duy_dy_vertopenslip =  (B_G3bv_uNN + B_G2bv_uNN + B_G3v_uNN)./1e3;
dux_dy_vertopenslip =  (B_G3bv_uEN + B_G2bv_uEN + B_G3v_uEN)./1e3;
dux_dz_vertopenslip =  (-1.*duz_dx_vertopenslip); % From free surface boundary condition (strain_xz = 0 at the surface)
...
sigma_ij_1000m_SLder.sigma_xx_vert = sigma_xx_vert;
sigma_ij_1000m_SLder.sigma_xy_vert = sigma_xy_vert;
sigma_ij_1000m_SLder.sigma_xz_vert = sigma_xz_vert;
sigma_ij_1000m_SLder.sigma_yx_vert = sigma_yx_vert;
sigma_ij_1000m_SLder.sigma_yy_vert = sigma_yy_vert;
sigma_ij_1000m_SLder.sigma_yz_vert = sigma_yz_vert;
sigma_ij_1000m_SLder.sigma_zx_vert = sigma_zx_vert;
sigma_ij_1000m_SLder.sigma_zy_vert = sigma_zy_vert;
sigma_ij_1000m_SLder.sigma_zz_vert = sigma_zz_vert;

sigma_ij_1000m_SLder.sigma_xx_vertopenslip = sigma_xx_vert + sigma_xx;
sigma_ij_1000m_SLder.sigma_xy_vertopenslip = sigma_xy_vert + sigma_xy;
sigma_ij_1000m_SLder.sigma_xz_vertopenslip = sigma_xz_vert + sigma_xz;
sigma_ij_1000m_SLder.sigma_yx_vertopenslip = sigma_yx_vert + sigma_yx;
sigma_ij_1000m_SLder.sigma_yy_vertopenslip = sigma_yy_vert + sigma_yy;
sigma_ij_1000m_SLder.sigma_yz_vertopenslip = sigma_yz_vert + sigma_yz;
sigma_ij_1000m_SLder.sigma_zx_vertopenslip = sigma_zx_vert + sigma_zx;
sigma_ij_1000m_SLder.sigma_zy_vertopenslip = sigma_zy_vert + sigma_zy;
sigma_ij_1000m_SLder.sigma_zz_vertopenslip = sigma_zz_vert + sigma_zz;

save sigma_ij_1000m_EWcurve_2011_t3.mat sigma_ij_1000m_SLder
...
path='Forward_1000m_check_plots_EWcurve_2011_t3'; %the folder where you want to put the file
name=sprintf('%04d_1000m_bedopen_bedslip',i); %what you want the file to be called
...
axes(axe1)
vv=[-1.5025:0.005:1.5025]; 
[C1,h1]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_E_open(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe2)
[C2,h2]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_N_open(i,:),121,121),vv);
set(h2,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe3)
vvv=[-1.0025:0.005:1.0025];
[C3,h3]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_U_open(i,:),121,121),vvv);
set(h3,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
set(fig1,'paperunits','inches','papersize',figpos(3:4)/resolution,'paperposition',[0 0 figpos(3:4)/resolution]); %dont need to change anything here
path='Forward_1000m_check_plots_EWcurve_2011_t3'; %the folder where you want to put the file
name=sprintf('%04d_1000m_bedopen',i); %what you want the file to be called
print(fig1,fullfile(path,name),'-dpng',['-r',num2str(rez)],'-opengl') %save file 
...
axes(axe1)
vv=[-1.5025:0.005:1.5025]; 
[C1,h1]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_E_slip(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe2)
[C2,h2]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_N_slip(i,:),121,121),vv);
set(h2,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe3)
vvv=[-1.0025:0.005:1.0025];
[C3,h3]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_U_slip(i,:),121,121),vvv);
set(h3,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
set(fig1,'paperunits','inches','papersize',figpos(3:4)/resolution,'paperposition',[0 0 figpos(3:4)/resolution]); %dont need to change anything here
path='Forward_1000m_check_plots_EWcurve_2011_t3'; %the folder where you want to put the file
name=sprintf('%04d_1000m_bedslip',i); %what you want the file to be called
print(fig1,fullfile(path,name),'-dpng',['-r',num2str(rez)],'-opengl') %save file 
...
fig1 = figure('Units','centimeters','Position',[0.5 0.5 25.5 22]);%,...
    ...
    set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', [], 'YTick', []); 
 %   
% HF open --> surface displacement
axes(axe1)
vv=[-1.5025:0.005:1.5025]; 
[C1,h1]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_E_vert(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
title('HF Open: Displacement, U','FontSize',10)
text(-21,19,sprintf('H = 1000 m   V = %4.3f km^{3}',Vtot(i)),'FontWeight','bold','FontSize',10);
% axis equal

axes(axe2)
[C2,h2]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_N_vert(i,:),121,121),vv);
set(h2,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe3)
vvv=[-1.0025:0.005:1.0025];
[C3,h3]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_U_vert(i,:),121,121),vvv);
set(h3,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
% HF open --> surface strain
axes(axe4)
vv=(10^(-4)).*[-1.5025:0.005:0.8025]; 
[C1,h1]=contourf(xx, yy, reshape(eps_xx_vert(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
title('HF Open: Strain, \epsilon','FontSize',10)
% axis equal

axes(axe5)
vv=(10^(-4)).*[-0.8025:0.005:0.8025]; 
[C1,h1]=contourf(xx, yy, reshape(eps_yy_vert(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe6)
vv=(10^(-4)).*[-0.8025:0.005:0.8025]; 
[C1,h1]=contourf(xx, yy, reshape(eps_zz_vert(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
plot(patchesC(1:6:end,6),patchesC(1:6:end,7),'y','LineWidth',1.5)
...
axes(axe7)
vvKPA=[-8005:10:8005]; v150=150;
[C4,h4]=contourf(xx, yy, reshape(sigma_xx_vert(i,:),121,121)./1e3,vvKPA);
set(h4,'LineColor','none'); 
hold on;
contour(xx, yy,reshape(sigma_xx_vert(i,:),121,121)./1e3,[v150 v150],'k','LineWidth',1.1);
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
plot(patchesC(1:6:end,6),patchesC(1:6:end,7),'y','LineWidth',1.5)
%scatter(xy_moulin(1,1),xy_moulin(1,2),10,'yo','filled','MarkerEdgeColor','k')
...
set(gca,'xtick',[-20:10:20],'ytick',[-20:10:20],'tickdir','out','LineWidth',1.1,'FontSize',10); 
grid on;
title('HF Open: Stress, \sigma','FontSize',10)


% sigma_yy
axes(axe8)
[C5,h5]=contourf(xx, yy, reshape(sigma_yy_vert(i,:),121,121)./1e3,vvKPA);
set(h5,'LineColor','none'); 
hold on;
contour(xx, yy,reshape(sigma_yy_vert(i,:),121,121)./1e3,[v150 v150],'k','LineWidth',1.1);
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
plot(patchesC(1:6:end,6),patchesC(1:6:end,7),'y','LineWidth',1.5)
%scatter(xy_moulin(1,1),xy_moulin(1,2),10,'yo','filled','MarkerEdgeColor','k')
...
% sigma_zz
axes(axe9)
[C5,h6]=contourf(xx, yy, reshape(sigma_zz_vert(i,:),121,121)./1e3,vvKPA);
set(h6,'LineColor','none'); 
hold on;
contour(xx, yy,reshape(sigma_zz_vert(i,:),121,121)./1e3,[v150 v150],'k','LineWidth',1.1);
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
plot(patchesC(1:6:end,6),patchesC(1:6:end,7),'y','LineWidth',1.5)
%colorbar; 
...
set(fig1,'paperunits','inches','papersize',figpos(3:4)/resolution,'paperposition',[0 0 figpos(3:4)/resolution]); %dont need to change anything here
path='Forward_1000m_check_plots_EWcurve_2011_t3'; %the folder where you want to put the file
name=sprintf('%04d_1000m_vert',i); %what you want the file to be called
print(fig1,fullfile(path,name),'-dpng',['-r',num2str(rez)],'-opengl') %save file 
