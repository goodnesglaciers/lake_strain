...
% distribution for vert patches = 2011 t_{3} NIF solution
close all; clear all;

%% load saved displacement, strain, stress, and idealized patches
load surface_disp_1000m_EWcurve_2011_t3.mat
load Gsurface1000m_strain_EWcurve.mat
load sigma_ij_1000m_EWcurve_2011_t3.mat
...
ylabel('y  [ km ]'); 
text(-11, 11, 'Crack Opening = 2011 t_{3} values','FontName','Avenir','FontSize',m-1)
...
%% print figure
figurename=sprintf('paperfig3_idealized_example_EWcurve_2011_t3_20230720.png');
