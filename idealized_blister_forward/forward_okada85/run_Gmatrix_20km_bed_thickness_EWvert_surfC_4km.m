...
[patchesC, patchesB, G3v, G2bv, G3bv, G3v_strain, G2bv_strain, G3bv_strain] = makegeom_20km_bed_EWvert_surfC_4km(origin,depthc(4));
...
save('Gsurface1250m_strain_EWvert_surfC_4km.mat', 'Gsurface', '-v7.3'); 
