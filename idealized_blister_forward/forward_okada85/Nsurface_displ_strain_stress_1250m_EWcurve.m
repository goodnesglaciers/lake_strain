...
load Gsurface1250m_strain_EWcurve.mat % 40 x 40 patch bed + 10-km-long vertical crack
...
surface_disp_1250m.Disp_E_vert = Disp_E_vert;
surface_disp_1250m.Disp_N_vert = Disp_N_vert;
surface_disp_1250m.Disp_U_vert = Disp_U_vert;
save surface_disp_1250m_EWcurve.mat surface_disp_1250m
...
sigma_ij_1250m_SLder.sigma_xx_vert = sigma_xx_vert;
sigma_ij_1250m_SLder.sigma_xy_vert = sigma_xy_vert;
sigma_ij_1250m_SLder.sigma_xz_vert = sigma_xz_vert;
sigma_ij_1250m_SLder.sigma_yx_vert = sigma_yx_vert;
sigma_ij_1250m_SLder.sigma_yy_vert = sigma_yy_vert;
sigma_ij_1250m_SLder.sigma_yz_vert = sigma_yz_vert;
sigma_ij_1250m_SLder.sigma_zx_vert = sigma_zx_vert;
sigma_ij_1250m_SLder.sigma_zy_vert = sigma_zy_vert;
sigma_ij_1250m_SLder.sigma_zz_vert = sigma_zz_vert;

sigma_ij_1250m_SLder.sigma_xx_vertopenslip = sigma_xx_vert + sigma_xx;
sigma_ij_1250m_SLder.sigma_xy_vertopenslip = sigma_xy_vert + sigma_xy;
sigma_ij_1250m_SLder.sigma_xz_vertopenslip = sigma_xz_vert + sigma_xz;
sigma_ij_1250m_SLder.sigma_yx_vertopenslip = sigma_yx_vert + sigma_yx;
sigma_ij_1250m_SLder.sigma_yy_vertopenslip = sigma_yy_vert + sigma_yy;
sigma_ij_1250m_SLder.sigma_yz_vertopenslip = sigma_yz_vert + sigma_yz;
sigma_ij_1250m_SLder.sigma_zx_vertopenslip = sigma_zx_vert + sigma_zx;
sigma_ij_1250m_SLder.sigma_zy_vertopenslip = sigma_zy_vert + sigma_zy;
sigma_ij_1250m_SLder.sigma_zz_vertopenslip = sigma_zz_vert + sigma_zz;

save sigma_ij_1250m_EWcurve.mat sigma_ij_1250m_SLder
...
path='Forward_1250m_check_plots_EWcurve'; %the folder where you want to put the file
name=sprintf('%04d_1250m_bedopen_bedslip',i); %what you want the file to be called
...
axes(axe1)
vv=[-1.5025:0.005:1.5025]; 
[C1,h1]=contourf(xx, yy, reshape(surface_disp_1250m.Disp_E_open(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe2)
[C2,h2]=contourf(xx, yy, reshape(surface_disp_1250m.Disp_N_open(i,:),121,121),vv);
set(h2,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe3)
vvv=[-1.0025:0.005:1.0025];
[C3,h3]=contourf(xx, yy, reshape(surface_disp_1250m.Disp_U_open(i,:),121,121),vvv);
set(h3,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
set(fig1,'paperunits','inches','papersize',figpos(3:4)/resolution,'paperposition',[0 0 figpos(3:4)/resolution]); %dont need to change anything here
path='Forward_1250m_check_plots_EWcurve'; %the folder where you want to put the file
name=sprintf('%04d_1250m_bedopen',i); %what you want the file to be called
print(fig1,fullfile(path,name),'-dpng',['-r',num2str(rez)],'-opengl') %save file 
...
axes(axe1)
vv=[-1.5025:0.005:1.5025]; 
[C1,h1]=contourf(xx, yy, reshape(surface_disp_1250m.Disp_E_slip(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe2)
[C2,h2]=contourf(xx, yy, reshape(surface_disp_1250m.Disp_N_slip(i,:),121,121),vv);
set(h2,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe3)
vvv=[-1.0025:0.005:1.0025];
[C3,h3]=contourf(xx, yy, reshape(surface_disp_1250m.Disp_U_slip(i,:),121,121),vvv);
set(h3,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
set(fig1,'paperunits','inches','papersize',figpos(3:4)/resolution,'paperposition',[0 0 figpos(3:4)/resolution]); %dont need to change anything here
path='Forward_1250m_check_plots_EWcurve'; %the folder where you want to put the file
name=sprintf('%04d_1250m_bedslip',i); %what you want the file to be called
print(fig1,fullfile(path,name),'-dpng',['-r',num2str(rez)],'-opengl') %save file 
...
axes(axe1)
vv=[-1.5025:0.005:1.5025]; 
[C1,h1]=contourf(xx, yy, reshape(surface_disp_1250m.Disp_E_vert(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe2)
[C2,h2]=contourf(xx, yy, reshape(surface_disp_1250m.Disp_N_vert(i,:),121,121),vv);
set(h2,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe3)
vvv=[-1.0025:0.005:1.0025];
[C3,h3]=contourf(xx, yy, reshape(surface_disp_1250m.Disp_U_vert(i,:),121,121),vvv);
set(h3,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
set(fig1,'paperunits','inches','papersize',figpos(3:4)/resolution,'paperposition',[0 0 figpos(3:4)/resolution]); %dont need to change anything here
path='Forward_1250m_check_plots_EWcurve'; %the folder where you want to put the file
name=sprintf('%04d_1250m_vert',i); %what you want the file to be called
print(fig1,fullfile(path,name),'-dpng',['-r',num2str(rez)],'-opengl') %save file 
