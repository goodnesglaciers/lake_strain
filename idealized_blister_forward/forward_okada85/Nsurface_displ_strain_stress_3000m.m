...
load Gsurface3000m_strain.mat % 40 x 40 patch bed
...
surface_disp_3000m.Disp_E = Disp_E;
surface_disp_3000m.Disp_N = Disp_N;
surface_disp_3000m.Disp_U = Disp_U;
surface_disp_3000m.Disp_E_slip = Disp_E_slip;
surface_disp_3000m.Disp_N_slip = Disp_N_slip;
surface_disp_3000m.Disp_U_slip = Disp_U_slip;
surface_disp_3000m.Disp_E_open = Disp_E_open;
surface_disp_3000m.Disp_N_open = Disp_N_open;
surface_disp_3000m.Disp_U_open = Disp_U_open;
save surface_disp_3000m.mat surface_disp_3000m
%load surface_disp_3000m.mat
...
%% save for plotting 
sigma_ij_3000m_SLder.sigma_xx = sigma_xx;
sigma_ij_3000m_SLder.sigma_xy = sigma_xy;
sigma_ij_3000m_SLder.sigma_xz = sigma_xz;
sigma_ij_3000m_SLder.sigma_yx = sigma_yx;
sigma_ij_3000m_SLder.sigma_yy = sigma_yy;
sigma_ij_3000m_SLder.sigma_yz = sigma_yz;
sigma_ij_3000m_SLder.sigma_zx = sigma_zx;
sigma_ij_3000m_SLder.sigma_zy = sigma_zy;
sigma_ij_3000m_SLder.sigma_zz = sigma_zz;

sigma_ij_3000m_SLder.sigma_xx_slip = sigma_xx_slip;
sigma_ij_3000m_SLder.sigma_xy_slip = sigma_xy_slip;
sigma_ij_3000m_SLder.sigma_xz_slip = sigma_xz_slip;
sigma_ij_3000m_SLder.sigma_yx_slip = sigma_yx_slip;
sigma_ij_3000m_SLder.sigma_yy_slip = sigma_yy_slip;
sigma_ij_3000m_SLder.sigma_yz_slip = sigma_yz_slip;
sigma_ij_3000m_SLder.sigma_zx_slip = sigma_zx_slip;
sigma_ij_3000m_SLder.sigma_zy_slip = sigma_zy_slip;
sigma_ij_3000m_SLder.sigma_zz_slip = sigma_zz_slip;

sigma_ij_3000m_SLder.sigma_xx_open = sigma_xx_open;
sigma_ij_3000m_SLder.sigma_xy_open = sigma_xy_open;
sigma_ij_3000m_SLder.sigma_xz_open = sigma_xz_open;
sigma_ij_3000m_SLder.sigma_yx_open = sigma_yx_open;
sigma_ij_3000m_SLder.sigma_yy_open = sigma_yy_open;
sigma_ij_3000m_SLder.sigma_yz_open = sigma_yz_open;
sigma_ij_3000m_SLder.sigma_zx_open = sigma_zx_open;
sigma_ij_3000m_SLder.sigma_zy_open = sigma_zy_open;
sigma_ij_3000m_SLder.sigma_zz_open = sigma_zz_open;

save sigma_ij_3000m.mat sigma_ij_3000m_SLder
...
[C1,h1]=contourf(xx, yy, reshape(surface_disp_3000m.Disp_E(i,:),121,121),vv);
...
text(-21,19,sprintf('H = 3000 m   V = %4.3f km^{3}',Vtot(i)),'FontWeight','bold','FontSize',10);
% axis equal

axes(axe2)
[C2,h2]=contourf(xx, yy, reshape(surface_disp_3000m.Disp_N(i,:),121,121),vv);
...
[C3,h3]=contourf(xx, yy, reshape(surface_disp_3000m.Disp_U(i,:),121,121),vvv);
...
path='Forward_3000m_check_plots'; %the folder where you want to put the file
name=sprintf('%04d_3000m_bedopen_bedslip',i); %what you want the file to be called
...
axes(axe1)
vv=[-1.5025:0.005:1.5025]; 
[C1,h1]=contourf(xx, yy, reshape(surface_disp_3000m.Disp_E_open(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe2)
[C2,h2]=contourf(xx, yy, reshape(surface_disp_3000m.Disp_N_open(i,:),121,121),vv);
set(h2,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe3)
vvv=[-1.0025:0.005:1.0025];
[C3,h3]=contourf(xx, yy, reshape(surface_disp_3000m.Disp_U_open(i,:),121,121),vvv);
set(h3,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
set(fig1,'paperunits','inches','papersize',figpos(3:4)/resolution,'paperposition',[0 0 figpos(3:4)/resolution]); %dont need to change anything here
path='Forward_3000m_check_plots'; %the folder where you want to put the file
name=sprintf('%04d_3000m_bedopen',i); %what you want the file to be called
print(fig1,fullfile(path,name),'-dpng',['-r',num2str(rez)],'-opengl') %save file 
...
axes(axe1)
vv=[-1.5025:0.005:1.5025]; 
[C1,h1]=contourf(xx, yy, reshape(surface_disp_3000m.Disp_E_slip(i,:),121,121),vv);
set(h1,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe2)
[C2,h2]=contourf(xx, yy, reshape(surface_disp_3000m.Disp_N_slip(i,:),121,121),vv);
set(h2,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
axes(axe3)
vvv=[-1.0025:0.005:1.0025];
[C3,h3]=contourf(xx, yy, reshape(surface_disp_3000m.Disp_U_slip(i,:),121,121),vvv);
set(h3,'LineColor','none'); 
hold on;
plot(xy_sta_11(:,1),xy_sta_11(:,2),'k^','MarkerSize',TriangleSize-5,'MarkerFaceColor','none'); hold on;
%scatter(xy_lake(:,1),xy_lake(:,2),2,'bo','filled','MarkerEdgeColor','none')
...
set(fig1,'paperunits','inches','papersize',figpos(3:4)/resolution,'paperposition',[0 0 figpos(3:4)/resolution]); %dont need to change anything here
path='Forward_3000m_check_plots'; %the folder where you want to put the file
name=sprintf('%04d_3000m_bedslip',i); %what you want the file to be called
print(fig1,fullfile(path,name),'-dpng',['-r',num2str(rez)],'-opengl') %save file 
