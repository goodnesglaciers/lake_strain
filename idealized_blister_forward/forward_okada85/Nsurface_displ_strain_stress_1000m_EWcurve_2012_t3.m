...
% 20 July 2023 LAS -- include a curved HF with opening of 2012 t_{3} 
...
load('../../NIF_forward/MLE2012_47_range7_gc_20km.mat')
% extract opening and slip along planes
time_2012 = ts_enu.epochs; % time vector
vert_crack_open_m_all_time = slip_b(1:Nsubfa,:)'; % m
vert_crack_open_m = repmat(vert_crack_open_m_all_time(544,:),5,1); % m at 2012 t_{3}
...
save surface_disp_1000m_EWcurve_2012_t3.mat surface_disp_1000m
...
save sigma_ij_1000m_EWcurve_2012_t3.mat sigma_ij_1000m_SLder
...
path='Forward_1000m_check_plots_EWcurve_2012_t3'; %the folder where you want to put the file
