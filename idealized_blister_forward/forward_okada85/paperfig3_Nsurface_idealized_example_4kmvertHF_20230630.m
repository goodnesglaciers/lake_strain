...
load surface_disp_1250m_EWvert_4km.mat
load Gsurface1250m_strain_EWvert_4km.mat
load sigma_ij_1250m_EWvert_4km.mat
...
hold on;
[c3,h3]=contourf(xx,yy,reshape(((surface_disp_1250m.Disp_U_openslip(5,:))),121,121),v_disp); 
set(h3,'LineColor','none'); 
FE = interp2(xx_init,yy_init,reshape(surface_disp_1250m.Disp_E_openslip(5,:),121,121),xx_plot,yy_plot);
FN = interp2(xx_init,yy_init,reshape(surface_disp_1250m.Disp_N_openslip(5,:),121,121),xx_plot,yy_plot);
quiver(xx_plot,yy_plot,quiver_scale.*FE,quiver_scale.*FN,'k','autoscale','off','LineWidth',0.6,'Color',BWR(10,:));
quiver(-9.00, 11.1, quiver_scale.*1, quiver_scale.*0, 'k','autoscale','off','LineWidth',1.0,...
    'Color',BWR(10,:),'MaxHeadSize',0.8);
text(-9, 10, '1 m','FontSize',m-1,'Color',BWR(10,:),'FontName','Avenir');
...
% %% print figure
% figurename=sprintf('paperfig3_idealized_example_4kmHF_20230710.png');
